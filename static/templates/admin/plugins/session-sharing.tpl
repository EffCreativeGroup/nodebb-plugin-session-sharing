      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-xs-12">
          <div class="form-group">
            <label for="name">REST API URL</label>
            <input type="text" id="rest-api-url" name="restApiUrl" title="REST API URL" class="form-control" placeholder="https://example.com/api/"/>
          </div>
